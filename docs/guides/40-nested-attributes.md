...
This approach is illustrated in the [getting started](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/getting_started) example:
