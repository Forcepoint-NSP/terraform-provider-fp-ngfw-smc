...
- see [here](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/sdwan/policy_based_vpn/central_gateway_node/main.tf) for a minimal example
