---
page_title: "application_access_rule"
...
# application_access_rule (Nested-Attribute)
...
## Simple Attributes
- `application_access_web_service` (List of String) URI of the Application Access web service.
