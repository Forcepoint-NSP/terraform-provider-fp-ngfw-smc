...
- [IP Service Group Example](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/services/ip-proto_service/main.tf)
