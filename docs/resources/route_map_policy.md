...
- [Route Map Example](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/examples/engines/dynamic_routing/route_map/)
