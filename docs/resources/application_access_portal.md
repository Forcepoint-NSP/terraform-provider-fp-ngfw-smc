---
page_title: "smc_application_access_portal"
...
# smc_application_access_portal (Resource)
...
- `application_access_policy` (String) This represents an Application Access Portal Policy, which is used to define portal access rules for the connections. It includes properties such as portal rules and access control.
...
## Nested Attributes
- `application_access_hostname` (List of Blocks, see [here](attr_application_access_hostname.md)) The Application Access Hostname elements.
