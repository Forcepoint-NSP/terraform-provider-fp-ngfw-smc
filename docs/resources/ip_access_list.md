...
- [IP Access List Example](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/engines/dynamic_routing/routing_node_bgp/main.tf)
