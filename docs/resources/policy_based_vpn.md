...
- [fw_policy_vpn example](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/policies/fw_policy_vpn/main.tf): Demonstrates configuring a firewall policy with VPN rules using the SMC provider.
