---
page_title: "smc_application_access_web_service"
...
# smc_application_access_web_service (Resource)
...
- `application_access_service_profile` (String) This represents an Application Access Service Profile. It contains settings for exceptions, HTTP fields, authentication type, NTLM support, and user input formats.
- `application_access_sso_domain` (String) This represents an Application Access Single Sign On Domain, which includes properties such as SSO mode and timeout settings.
...
## Nested Attributes
- `application_access_allowed_url` (List of Blocks, see [here](attr_application_access_allowed_url.md)) List of allowed URLs for the Application Access Web Service.
- `application_access_althost` (List of Blocks, see [here](attr_application_access_hostname.md)) List of alternative hostnames for the Application Access Web Service.
