...
- see [here](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/policies/fw_ipv4_access_rule_section) for a minimal example
