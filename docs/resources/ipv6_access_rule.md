...
- [fw_template_policy/main.tf](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.741.0/examples/policies/fw_template_policy/main.tf): Multiple IPv6 access rules in a policy template.
