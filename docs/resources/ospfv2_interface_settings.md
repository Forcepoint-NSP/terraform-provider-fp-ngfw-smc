...
- [OSPFv2 Interface Settings Example](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/engines/dynamic_routing/OSPFv2/ospfv2_interface_settings/main.tf)
...
- `hello_interval_type` (String) The type of Hello interval used in OSPF, which can be 'normal', or 'fast_hello'.
