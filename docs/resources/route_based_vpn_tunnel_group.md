...
- [RBVPN Tunnel Group Example](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/sdwan/route_based_vpn/vpn_mode/main.tf)
