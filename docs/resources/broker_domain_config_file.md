...
- see [here](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/engines/fw_cluster/fw_cluster_with_vpn_broker_interface) for an example
