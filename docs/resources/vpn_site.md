...
- [satellite_gateway_node/main.tf](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/0.0.1/examples/sdwan/policy_based_vpn/satellite_gateway_node/main.tf): Creates a VPN site for a firewall's internal gateway in SD-WAN.
