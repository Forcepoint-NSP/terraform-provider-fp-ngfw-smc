...
- see [here](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/engines/single_fw/single_fw_vlan_interfaces) for a full example
