...
- `filter_type` (String) The type of filter applied to the redistribution, such as none, access_list, route_map_policy, always_on, or route_map_policy_with_always_on.
