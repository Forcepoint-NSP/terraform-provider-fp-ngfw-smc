...
- [fw_policy_with_match_expression/main.tf](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/policies/fw_policy_with_match_expression/main.tf): Defines a single host object for use in firewall policy.
