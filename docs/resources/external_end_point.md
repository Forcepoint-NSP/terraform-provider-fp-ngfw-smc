...
- [SD-WAN External Endpoint Example](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/sdwan/external_gateway/main.tf)
