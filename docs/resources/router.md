...
- [getting_started/main.tf](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.741.0/examples/getting_started/main.tf): Basic router creation for a test network and single firewall setup.
