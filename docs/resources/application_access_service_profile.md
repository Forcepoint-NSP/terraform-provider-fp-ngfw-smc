---
page_title: "smc_application_access_service_profile"
...
# smc_application_access_service_profile (Resource)
...
## Nested Attributes
- `application_access_http_field` (List of Blocks, see [here](attr_application_access_http_field.md)) The Application Access HTTP fields.
- `application_access_profile_exception` (List of Blocks, see [here](attr_application_access_hostname.md)) The Application Access Hostname exceptions.
