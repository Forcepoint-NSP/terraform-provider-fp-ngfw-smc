...
- [sub_ipv4_fw_policy/main.tf](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/policies/sub_ipv4_fw_policy/main.tf): Creates a sub-IPv4 firewall policy.
