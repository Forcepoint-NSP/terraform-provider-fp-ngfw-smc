...
- [fw_policy_with_match_expression/main.tf](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.741.0/examples/policies/fw_policy_with_match_expression/main.tf): Adds a test internal SMC user account for authentication testing in policies.
