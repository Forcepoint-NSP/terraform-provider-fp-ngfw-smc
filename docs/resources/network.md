...
- [getting_started/main.tf](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/getting_started/main.tf): Defines a basic network element for a test/lab environment.
