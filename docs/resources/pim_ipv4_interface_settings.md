...
- [PIM IPv4 Interface Settings Example](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/engines/dynamic_routing/PIM/pim_ipv4_interface_settings/main.tf)
