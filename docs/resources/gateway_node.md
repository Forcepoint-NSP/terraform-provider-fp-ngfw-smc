...
- [external_gateway example](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/sdwan/external_gateway/main.tf): Adds gateway nodes (central) in a policy-based VPN SD-WAN scenario.
