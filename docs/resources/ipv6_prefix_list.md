...
- [ipv6_prefix_list/main.tf](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/engines/dynamic_routing/ipv6_prefix_list/main.tf): Example of an IPv6 prefix list for BGP or route filtering.
