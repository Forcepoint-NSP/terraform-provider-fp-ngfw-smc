...
- [fw_policy_with_match_expression/main.tf](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/policies/fw_policy_with_match_expression/main.tf): Builds a match expression referencing multiple resources in a firewall policy.
