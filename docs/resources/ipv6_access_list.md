...
- [ipv6_access_list/main.tf](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/engines/dynamic_routing/ipv6_access_list/main.tf): Lists IPv6 permit/deny entries for access lists.
