...
- [OSPFv2 Domain Settings Example](https://github.com/Forcepoint-NSP/terraform-provider-fp-ngfw-smc/blob/release/1.750.0/examples/engines/dynamic_routing/OSPFv2/ospfv2_domain_settings/main.tf)
