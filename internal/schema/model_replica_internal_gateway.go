...
type ReplicaInternalGatewayResourceModel struct {
	...
	LinkedGatewayRef types.String                                       `tfsdk:"linked_gateway_ref" json:"linked_gateway_ref,optional,omitempty" `
	...
	ReplicaEndpoints *[]types.String                                    `tfsdk:"replica_endpoints" json:"replica_endpoints,optional,omitempty" `
