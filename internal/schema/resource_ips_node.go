...
var _ resource.ResourceWithValidateConfig = &IpsNodeResource{}

func (r *IpsNodeResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data IpsNodeResourceModel
...
func (r *IpsNodeResource) validateTests(data IpsNodeResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Tests != nil {
