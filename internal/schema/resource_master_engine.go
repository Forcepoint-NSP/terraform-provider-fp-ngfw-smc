...
var _ resource.ResourceWithValidateConfig = &MasterEngineResource{}

func (r *MasterEngineResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data MasterEngineResourceModel
	...
	r.validateVirtualResources(data, resp)
}

func (r *MasterEngineResource) validateNodes(data MasterEngineResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Nodes != nil {
...
func (r *MasterEngineResource) validatePhysicalInterfaces(data MasterEngineResourceModel, resp *resource.ValidateConfigResponse) {
...
func (r *MasterEngineResource) validateTests(data MasterEngineResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Tests != nil {
...
func (r *MasterEngineResource) validateVirtualResources(data MasterEngineResourceModel, resp *resource.ValidateConfigResponse) {
	if data.VirtualResources != nil {
		for _i0, _v0 := range *data.VirtualResources {
			smcresource.ValidateAnyOf(&_v0, fmt.Sprintf("virtual_resources[%d]", _i0), &resp.Diagnostics)
		}
	}
}
