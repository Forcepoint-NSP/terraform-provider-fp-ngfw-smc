...
var _ resource.ResourceWithValidateConfig = &Layer2SingleResource{}

func (r *Layer2SingleResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data Layer2SingleResourceModel
...
func (r *Layer2SingleResource) validateNodes(data Layer2SingleResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Nodes != nil {
...
func (r *Layer2SingleResource) validatePhysicalInterfaces(data Layer2SingleResourceModel, resp *resource.ValidateConfigResponse) {
...
func (r *Layer2SingleResource) validateTests(data Layer2SingleResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Tests != nil {
