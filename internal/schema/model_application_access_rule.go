...
// This file was automatically generated from OpenAPI schema: Application_Access_Rule
...
type ApplicationAccessRuleResourceModel struct {
	AdminDomain                 types.String                                       `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
	ApplicationAccessWebService *[]types.String                                    `tfsdk:"application_access_web_service" json:"application_access_web_service,optional,omitempty" `
...
func (r *ApplicationAccessRuleResourceModel) GetSliceIds(ctx context.Context) []string {
