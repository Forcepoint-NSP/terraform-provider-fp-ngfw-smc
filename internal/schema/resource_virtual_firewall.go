...
var _ resource.ResourceWithValidateConfig = &VirtualFirewallResource{}

func (r *VirtualFirewallResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data VirtualFirewallResourceModel
...
func (r *VirtualFirewallResource) validateNodes(data VirtualFirewallResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Nodes != nil {
...
func (r *VirtualFirewallResource) validatePhysicalInterfaces(data VirtualFirewallResourceModel, resp *resource.ValidateConfigResponse) {
...
func (r *VirtualFirewallResource) validateTests(data VirtualFirewallResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Tests != nil {
