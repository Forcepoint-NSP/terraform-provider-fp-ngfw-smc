...
var _ resource.ResourceWithValidateConfig = &SingleIpsResource{}

func (r *SingleIpsResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data SingleIpsResourceModel
...
func (r *SingleIpsResource) validateNodes(data SingleIpsResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Nodes != nil {
...
func (r *SingleIpsResource) validatePhysicalInterfaces(data SingleIpsResourceModel, resp *resource.ValidateConfigResponse) {
...
func (r *SingleIpsResource) validateTests(data SingleIpsResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Tests != nil {
