...
type ApplicationAccessLogonPageBackgroundResourceModel struct {
...
func (r *ApplicationAccessLogonPageBackgroundResourceModel) GetSliceIds(ctx context.Context) []string {
