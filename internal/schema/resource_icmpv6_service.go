...
var _ resource.ResourceWithValidateConfig = &Icmpv6ServiceResource{}

func (r *Icmpv6ServiceResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data Icmpv6ServiceResourceModel
...
func (r *Icmpv6ServiceResource) validatePaValues(data Icmpv6ServiceResourceModel, resp *resource.ValidateConfigResponse) {
