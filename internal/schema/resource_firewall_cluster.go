...
// Ensure FirewallClusterResource implements ResourceWithUpgradeState.
var _ resource.ResourceWithUpgradeState = &FirewallClusterResource{}

// UpgradeState implements resource.ResourceWithUpgradeState.
func (r *FirewallClusterResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
	use_hcl2, err := config.IsHcl2Enabled(common.PROVIDER_TYPE_NAME + "_" + r.ResourceType)
	if err == nil {
		ctx = context.WithValue(ctx, "use_hcl2", use_hcl2)
	}
	return upgradeFirewallClusterState(ctx)
}
...
var _ resource.ResourceWithValidateConfig = &FirewallClusterResource{}

func (r *FirewallClusterResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data FirewallClusterResourceModel
...
func (r *FirewallClusterResource) validateNodes(data FirewallClusterResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Nodes != nil {
...
func (r *FirewallClusterResource) validatePhysicalInterfaces(data FirewallClusterResourceModel, resp *resource.ValidateConfigResponse) {
...
func (r *FirewallClusterResource) validateTests(data FirewallClusterResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Tests != nil {
