...
var _ resource.ResourceWithValidateConfig = &VssContextResource{}

func (r *VssContextResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data VssContextResourceModel
...
func (r *VssContextResource) validateNodes(data VssContextResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Nodes != nil {
...
func (r *VssContextResource) validatePhysicalInterfaces(data VssContextResourceModel, resp *resource.ValidateConfigResponse) {
...
func (r *VssContextResource) validateTests(data VssContextResourceModel, resp *resource.ValidateConfigResponse) {
	if data.Tests != nil {
